<x-app-layout>
    @push('breadcrumb')
        {{ Breadcrumbs::render('admin.milks.create') }}
    @endpush
    <div class="row">
        <div class="col-sm-12 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.milks.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-6">
                                            ...
                                            <div class="col-sm-6 col-12">
                                                <div class="mb-3">
                                                    <label class="form-label">Shelf Lift (Day) <span
                                                            class="text-red">*</span></label>
                                                    <input type="number" name="shelf_life" value="{{ old('shelf_life') }}"
                                                        class="form-control"placeholder="Enter Name">
                                                    @error('shelf_life')
                                                        <div class="invalid-feedback d-block">{{ $message }}
                                                        </div>
                                            ...
                                            <div class="col-sm-6 col-12">
                                                <div class="mb-3">
                                                    <label class="form-label">Fat Content (%) <span
                                                            class="text-red">*</span></label>
                                                    <input type="number" name="fat_content" value="{{ old('fat_content') }}" min="0" value="0" step="any"
                                            ...
                                            <div class="col-sm-6 col-12">
                                                <div class="mb-3">
                                                    <label class="form-label">Volume (Liter) <span
                                                            class="text-red">*</span></label>
                                                    <input type="number" name="volume" value="{{ old('volume') }}" min="0" value="0" step="any"
                                            ...
                                            <div class="col-sm-6 col-12">
                                                <div class="mb-3">
                                                    <label class="form-label">MRP ({{$companyState->currency->symbol}}) <span
                                                            class="text-red">*</span></label>
                                                    <input type="number" name="mrp" value="{{ old('mrp') }}" min="0" value="0" step="any"
                                            ...
                                            <div class="col-sm-6 col-12">
                                                <div class="mb-3">
                                                    <label class="form-label">MOP ({{$companyState->currency->symbol}}) <span
                                                            class="text-red">*</span></label>
                                                    <input type="number" name="mop" value="{{ old('mop') }}" min="0" value="0" step="any"
