                        ...
                        <ul class="user-messages">
                            ...
                            <li>
                                ...
                                <div class="delivery-details">
                                    ...
                                    <p>Boost your sales by 50% with the easiest and proven marketing tool for customer
                                        enggement
                                        &amp; motivation.</p>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="delivery-details">
                                    ...
                                    <h5>Teboho Ncube</h5>
                                    <p>Use an exclusive promo code HKYMM50 and get 50% off on your first order in the
                                        new year.
                                    </p>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="delivery-details">
                                    ...
                                    <h5>Carla Jackson</h5>
                                    <p>Befor inviting the administrator, you must create a role that can be assigned to
                                        them.
                                    </p>
                                </div>
                            </li>
