                                            ...
                                            <div class="col-sm-6 col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="code" value="{{ old('code',$product->code) }}" class="form-control"placeholder="Enter Product Code">
                                                    </div>
                                                    @error('code')
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label class="form-label">Description <span
                                                            class="text-red">*</span></label>
                                                    <textarea rows="4" class="form-control" name="description" placeholder="Enter Description">{{ old('description',$product->description) }}</textarea>
                                                    @error('description')
                                                        <div class="invalid-feedback d-block">{{ $message }}
                                                        </div>
                                                    @enderror
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <img src="{{ old('https://placehold.co/200x200',$product->product_image) }}"
                                                        style="height: 200px"
